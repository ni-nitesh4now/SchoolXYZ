...
import {createLesson,updateLesson,getClassData,getBook,getPublicationData,getBoardData,getBookName} from '../api/auth';
...
// console.log("inside usefffect",searchParams.get('informativeQues'))
      ...
      const handleUpdateLesson=async(isManual)=>{
       ...
       let c="Days"+activeButtonIndex
        ...
        const newDay = {
          ...
          if(daysData.length==0 || (activeButtonIndex==0 && daysData.length==1)){
    ...
    useEffect(()=>{
        if(activeButton==='Conceptual' &&activeQButton>serviceQList.length&& serviceQList.length<conceptualQuestionList.length){
              setServiceQList([...serviceQList,{'qservice':''}]);
        }
        else if(activeButton==='Informative'&&activeQButton>serviceQList.length-1&& serviceQList.length<informativeQuestionList.length){
            setServiceQList([...serviceQList,{'qservice':''}]);
      }
      else if(activeButton==='Colearning' &&activeQButton>serviceQList.length-1&& serviceQList.length<colearningQuestionList.length){
        setServiceQList([...serviceQList,{'qservice':''}]);
  }
                ...
                <div className='lessonRow1'>
                    ...
                    <div className='lessonRow3'>
                        ...
                        <div  className='r3c'><InputGroup className="mb-3">
                                <textarea rows={1} style={{ resize: 'none' }} placeholder="Objective"className="txtDetail" value={objective} onChange={(event) => handleTextAreaChange(event, setObjective)} />
                            </InputGroup>
    ...
    />
                    ...
                    <div className='lessonRow5'>
                        ...
                        <textarea rows={1} style={{ resize: 'none' }} placeholder="Application" value={application} onChange={(event) => handleTextAreaChange(event, setApplication)}  />
                            </InputGroup>
                        </div>
                        <div  className='r5c'><InputGroup className="mb-5">
                        <textarea rows={1} style={{ resize: 'none' }} placeholder="Relevance to text" value={releText} onChange={(event) => handleTextAreaChange(event, setReleText)} />
                            </InputGroup>

                        </div>
                        <div className='r5c'>
                        <InputGroup className="mb-5">
                        <textarea rows={1} style={{ resize: 'none' }} placeholder="Skill gained" value={skillGain} onChange={(event) => handleTextAreaChange(event, setSkillGain)} />
                            </InputGroup>
                        </div>
                    </div>
                    <div className='lessonRow5'>
                        <div className='r5c'>
                        <InputGroup className="mb-5">
                        <textarea rows={1} style={{ resize: 'none' }} placeholder="Events" value={events} onChange={(event) => handleTextAreaChange(event, setEvents)} />
                            </InputGroup>
                        </div>
                        <div  className='r5c'><InputGroup className="mb-5">
                        <textarea rows={1} style={{ resize: 'none' }} placeholder="Problems" value={problem} onChange={(event) => handleTextAreaChange(event, setProblem)}  />
                            </InputGroup>

                        </div>
                        <div className='r5c'>
                        <InputGroup className="mb-5">
                        <textarea rows={1} style={{ resize: 'none' }} placeholder="Career path" value={careerPath} onChange={(event) => handleTextAreaChange(event, setCareerPath)}  />
                            </InputGroup>
                        </div>
                    </div>
                         ...
                         <div className='b2row2'>
                                        {
                                           ...
                                           {serviceQList.length-1==index && <div className='first-div'>
                                                {
                            ...
                            <div className='b2row3'>
                                  ...
                                  <Form.Select aria-label="Default select example" id="option"   style={{outline:'none'}} className='form custom-dropdown' onChange={handleQuestionTypeChange}>
                                        ...
                                        <option  className="optins"value="text">Rich Text</option>
                                 ...
                                 {selectedQuestionType==="text" &&( <div className='row3c'>
                                  ...
                                  <div className='row3c'>
                                  <Form.Select aria-label="Default select example"   style={{outline:'none'}} className='form custom-dropdown' onChange={handleLabel}>
                                        <option>Label</option>
                           ...
                           { (selectedQuestionType==="text" || selectedQuestionType==="mcq")&& (<div className='b2row4'>
                           <ReactQuill
                            value={txtQuestion}
    ...
    <div className="mb-3">
      <div className='row6rightcol'>
        ...
        <label>False</label>
                            ...
                            <Form.Control type="text" placeholder="Answer" className='filluptxt'  value={txtAnswer}
                                 onChange={(event) => setTxtAnswer(event.target.value)} />
                            </div>)}
                            ...
                            <div className='b2row6'>
                                 ...
                                 <div className="mb-3">
                                        ...
                                        <input type='text'  className="custom-radio-label" placeholder=' option1' value={option1Text} onChange={(e)=>setOption1Text(e.target.value)}></input>
                                        </div>
                                        <div className='row6rightcol'>
                                        ...
                                        <input type='text'  className="custom-radio-label" placeholder=' option2' value={option2Text} onChange={(e)=>setOption2Text(e.target.value)}></input>
                                    </div>
                                    <div className='row6rightcol'>
                                        <input
                                        type="radio"
                                        ...
                                        />
                                    <input type='text'  className="custom-radio-label" placeholder=' option3' value={option3Text} onChange={(e)=>setOption3Text(e.target.value)}></input>
                                    </div>
                                    <div className='row6rightcol'>
                                     ...
                                     <input type='text'  className="custom-radio-label" placeholder=' option4' value={option4Text} onChange={(e)=>setOption4Text(e.target.value)}></input>
                                    </div>
                                    </div>
                                 </div>
                            </div>)}
      ...
      handleUpdateLesson(false);
    }} style={{marginBottom:'-50px'}}>Save</button>
                    </div>}
