...
import { getUserByEmail ,getBoards,getPublications,getBooks,getClasses,getBookNames, createBookName, createLesson} from '../api/auth';
...
const Createplan = () => {
    ...
    const isAllFieldsSelected = (selectedClass && selectedClass!=="Class") &&(selectedPublisher && selectedPublisher!=="Publisher")&& (selectedStream && selectedStream!=="Stream");
    ...
    const handleBookNameChange = (event) => {
      ...
      const handleAdd = async() => {
        handleClose();
        console.log("here handleAdd",selectedBoard,selectedPublisher,selectedStream)
            ...
            <Usersidebar>
                ...
                <Row style={addbook}>
                    <Col >
                        ...
                        >
                            <option>Board</option>
                                {boardsArray && boardsArray.length > 0 && boardsArray.map((bd, index) => (
                    ...
                    <Col >
                        ...
                        >
                            <option>Class</option>
                                {classArray && classArray.length > 0 && classArray.map((c, index) => (
                    ...
                    <Form.Select
                        ...
                        >
                         <option>Stream</option>
                                {streamArray && streamArray.length > 0 && streamArray.map((s, index) => (
                    ...
                    <Form.Select
                        ...
                        >
                            <option>Publisher</option>
                                {publicationArray && publicationArray.length > 0 && publicationArray.map((pb, index) => (
