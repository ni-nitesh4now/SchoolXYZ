...
import {
    FaBook, FaCheckDouble, FaBars, FaSchool, FaChalkboardTeacher,
} from "react-icons/fa"
import {
    BiUserCircle, BiRename
} from "react-icons/bi"
import {
    GiPapers, GiProgression
} from "react-icons/gi"
import {
    MdPlayLesson,
} from "react-icons/md"
    ...
    return (
        <div className='container'>
            <div style={{ width: isOpen ? "30vw" : "60px"}} className='sidebar'>
                ...
                <div className='sidenav_bottom' style={{ marginTop: isOpen ? "40px" : "40px" }} >
