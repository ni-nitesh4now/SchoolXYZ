...
const Createlessonplan = () => {
 ...
 &id=${encodeURIComponent(
   lesson.data._id
 )}}&informativeQues=${encodeURIComponent(
      lesson.data.informativeQues
    )}&conceptualQues=${encodeURIComponent(lesson.data.conceptualQues)}
 &colearningQues=${encodeURIComponent(
   lesson.data.colearningQues
 )}&operation=admin`);
              ...
              {lesson.map((l, index) => (
                ...
                >
                  ...
                  <a
                    ...
                    onClick={() => handleDeleteLessonPlan(l._id)}
                  >
                    <AiFillDelete />
                  </a>
                </div>
